...
#### Colombian Symbolism in _One Hundred Years of Solitude__
...
#### **Synchronized Multimedia Integration Language (SMIL (/smaɪl/))**  
is a World Wide Web Consortium recommended Extensible Markup Language (XML) markup language to describe _multimedia presentations_.  
...
#### **Fountain**  
is a free and open-source plain text markup language that makes it possible to _write a formatted screenplay_ in any text editor, on any device, using any software that edits text files.
...
[Whamageddon](https://www.youtube.com/watch?v=E8gmARGvPlI)

![Picture](https://i.kym-cdn.com/photos/images/original/002/106/884/74c.jpg)
